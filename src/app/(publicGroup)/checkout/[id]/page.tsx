...
// import { createRentalAction } from "@/app/(dashboardGroup)/_actions/createRental";
// // import { createRentalAction } from "@/app/(dashboardGroup)/_actions/createRentalAction";
...
export default function CheckoutPage({ params }: Props) {
  ...
  const handleConfirmRental = async () => {
    try {
      ...
      console.log("Create rental result:", result);
