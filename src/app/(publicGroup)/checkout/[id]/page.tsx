...
export default function CheckoutPage({ params }: Props) {
  ...
  // ৩. Stripe Hosted Checkout Process
  const handleStripeCheckout = async () => {
    if (!startDate || !endDate) {
      toast.error("Please select start date and end date");
      return;
    ...
    try {
      ...
      // Rental Order ID নেওয়া (_id বা id)
      const rentalOrderId =
      ...
      // 🔍 Debugging log (Console F12 এ আসল স্ট্রাকচার দেখার জন্য)
      console.log("🔥 Backend Payment Response:", paymentData);
      ...
      // 🚀 ব্যাকএন্ড থেকে আসা সম্ভাব্য বিভিন্ন কি (Key) নাম চেক করা
      const checkoutUrl =
      ...
      if (checkoutUrl && typeof checkoutUrl === "string") {
        // Stripe Checkout Page-এ রিডাইরেক্ট
