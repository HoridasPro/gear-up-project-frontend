...
export default function ProviderSidebar() {
  return (
    <Sidebar className="sticky top-16 h-[calc(100vh-4rem)] border-r border-b mb-8 border-slate-800/60 border-slate-800/60 bg-[#0b0f19]/90 text-slate-100 backdrop-blur-2xl">
      {/* Header */}
