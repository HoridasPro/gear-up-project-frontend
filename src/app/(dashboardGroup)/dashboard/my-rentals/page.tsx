...
import PayNowButton from "../../_components/payNowButton/payNowButton";
import CancelRentalButton from "../../_components/cancelRentalButton";
...
const MyRentalsPage = async () => {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 text-gray-100 p-4 sm:p-6 lg:p-8 overflow-x-hidden">
      ...
      {rentals.length === 0 ? (
        <div className="flex h-64 items-center justify-center rounded-2xl border border-dashed border-gray-800 bg-[#0b0f19]/80 p-6 shadow-2xl backdrop-blur-xl overflow-x-hidden">
        ...
        <div className="rounded-2xl border border-gray-800/80 bg-[#0b0f19]/80 shadow-2xl backdrop-blur-xl overflow-x-hidden">
            ...
            <tbody className="divide-y divide-gray-800/60">
              {rentals.map((rental, index) => (
                <tr key={rental.id} className="transition hover:bg-gray-800/40">
                  ...
                  <td className="px-4 py-4 sm:px-6 text-center whitespace-nowrap">
                    {rental.status === "PLACED" ? (
                      <CancelRentalButton rentalOrderId={rental.id} />
